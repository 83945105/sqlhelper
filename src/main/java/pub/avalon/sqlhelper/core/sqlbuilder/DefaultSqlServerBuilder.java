 ...
 * @date 2019/5/22
 */
public class DefaultSqlServerBuilder extends AbstractSqlServerBuilder {

    public DefaultSqlServerBuilder(SqlBuilderOptions sqlBuilderOptions) {
    ...
    public SqlBuilder copyTable(String targetTableName, boolean copyData) {
        ...
        this.preparedStatementSql.append("select * into ")
        ...
        this.preparedStatementSql.append(" where 1 = 2");
        return this;
    }
    ...
    public SqlBuilder renameTable(String newTableName) {
        this.preparedStatementSql = new StringBuilder(32);
        this.preparedStatementArgs = new ArrayList<>(0);
        this.preparedStatementSql.append("exec sp_rename '")
                .append(this.sqlData.getMainTableData().getTableName())
                .append("', '")
                .append(newTableName)
                .append("'");
    ...
    public SqlBuilder isTableExist() {
        this.preparedStatementSql = new StringBuilder(128);
        this.preparedStatementArgs = new ArrayList<>(0);
        this.preparedStatementSql.append("select [name] from sysobjects where type='u' and [name] = '")
                .append(this.sqlData.getMainTableData().getTableName())
                .append("'");
        return this;
    }
