...
public abstract class AbstractSqlServerBuilder implements SqlBuilder {
    ...
    public AbstractSqlServerBuilder(SqlBuilderOptions sqlBuilderOptions) {
    ...
    protected StringBuilder appendLimitSql(StringBuilder stringBuilder) {
        ...
        StringBuilder rowNumSql = new StringBuilder(64);
        ...
        stringBuilder.insert(7, rowNumSql.toString())
