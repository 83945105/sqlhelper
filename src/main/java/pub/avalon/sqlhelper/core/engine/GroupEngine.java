...
public class GroupEngine<T extends TableHelper<T, TO, TC, TW, TG, TS>,
    ...
    public GroupEngine(Class<T> tableHelperClass) {
        super(tableHelperClass);
    }

    public GroupEngine(String tableName, Class<T> tableHelperClass) {
        super(tableName, tableHelperClass);
    }

    public GroupEngine(String tableName, Class<T> tableHelperClass, String alias) {
