...
public final class MySqlDynamicEngine {
    ...
    public static <T extends TableModel<T, TO, TC, TW, TG, TS>,
        ...
        return new QueryEngine<>(tableName, tableModelClass).setDataBaseType(DataBaseType.MYSQL);
    }
    ...
    public static <T extends TableModel<T, TO, TC, TW, TG, TS>,
        ...
        return new InsertEngine<>(tableName, tableModelClass).setDataBaseType(DataBaseType.MYSQL);
    }
    ...
    public static <T extends TableModel<T, TO, TC, TW, TG, TS>,
        ...
        return new UpdateEngine<>(tableName, tableModelClass).setDataBaseType(DataBaseType.MYSQL);
    }
    ...
    public static <T extends TableModel<T, TO, TC, TW, TG, TS>,
        ...
        return new DeleteEngine<>(tableName, tableModelClass).setDataBaseType(DataBaseType.MYSQL);
    }
