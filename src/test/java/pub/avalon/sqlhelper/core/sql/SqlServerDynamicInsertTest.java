 ...
 */
public class SqlServerDynamicInsertTest {
    ...
    void TestInsertArgs() {
        ...
        SqlBuilder sqlBuilder = SqlServerDynamicEngine.insert(JurRoleModel.class)
                .insertArgs(args);
        ...
        sqlBuilder = SqlServerDynamicEngine.insert("root_jur_role", JurRoleModel.class)
                .insertArgs(args);
        ...
        sqlBuilder = SqlServerDynamicEngine.insert(JurRoleModel.class)
