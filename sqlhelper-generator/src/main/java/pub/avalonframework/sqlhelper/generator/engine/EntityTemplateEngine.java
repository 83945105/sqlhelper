 ...
 * @author baichao
 */
public final class EntityTemplateEngine implements TemplateEngine {

    private final Logger logger = LoggerFactory.getLogger(EntityTemplateEngine.class);
    ...
    public EntityTemplateEngine(JdbcTemplate jdbcTemplate, GenerateOptions defaultGenerateOptions) {
    ...
    public String generateJavaCode(String tableName, OutputOptions outputOptions) {
        ...
        Template template = velocityEngine.getTemplate("/templates/entity.java.vm", StandardCharsets.UTF_8.name());
    ...
    public void generateJavaFile(String tableName, OutputOptions outputOptions) {
        ...
        printJavaFile(table.getEntityJavaFileName(), folderPath, javaCode);
    ...
    public void generateClassFile(String tableName, OutputOptions outputOptions) {
        ...
        Table table = getTable(tableName);
        String folderPath = buildPathPrefix(outputOptions.getFolderPath(), table.getGenerateOptions().getPackagePath());
        printClassFile(table.getEntityJavaFileName(), folderPath, javaCode, outputOptions.getFolderPath(), outputOptions.getCompileOptions());
