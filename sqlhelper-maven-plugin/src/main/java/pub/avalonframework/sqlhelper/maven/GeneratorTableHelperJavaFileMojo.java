 ...
 * @author baichao
 */
@Mojo(name = "generate table helper java file", defaultPhase = LifecyclePhase.COMPILE)
public class GeneratorTableHelperJavaFileMojo extends AbstractGeneratorMojo {
