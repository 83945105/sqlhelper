...
public class GeneratorJavaFileMojo extends AbstractGeneratorMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        TemplateEngine templateEngine = TemplateEngineBuilder.newTemplateEngineBuilder()
                ...
                .build();
        try {
            templateEngine.setDefaultGenerateOptions(convertGenerateOptions(defaultGenerateOptions));
            for (Table table : tables) {
                ...
                if (table.getOutputOptions() == null) {
                    templateEngine.generateJavaFile(table.getTableName(), convertOutputOptions(defaultOutputOptions));
                } else {
